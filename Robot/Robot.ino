...
unsigned int passTrackLeftHoles[5];         // contain the encoders left holes at checkpoints
unsigned int passTrackRightHoles[5];         // contain the encoders right holes at checkpoints
